...
// MFCApplicationDialogBaseList.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCApplicationDialogBaseListApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCApplicationDialogBaseListApp

CMFCApplicationDialogBaseListApp::CMFCApplicationDialogBaseListApp()
{
...
// Единственный объект CMFCApplicationDialogBaseListApp

CMFCApplicationDialogBaseListApp theApp;


// Инициализация CMFCApplicationDialogBaseListApp

BOOL CMFCApplicationDialogBaseListApp::InitInstance()
{
	...
	CMFCApplicationDialogBaseListDlg dlg;
	m_pMainWnd = &dlg;
